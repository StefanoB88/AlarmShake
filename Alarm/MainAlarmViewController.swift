...
class MainAlarmViewController: UITableViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == Id.addSegueIdentifier {
            ...
            addEditController.segueInfo = SegueInfo(curCellIndex: alarmModel.count, isEditMode: false, label: "Alarm", mediaLabel: "Digital", mediaID: "", repeatWeekdays: [], enabled: false, snoozeEnabled: false)
        }
